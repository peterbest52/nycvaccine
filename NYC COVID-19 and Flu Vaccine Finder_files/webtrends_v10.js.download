...
if (typeof (test_host) == 'undefined') var test_host = "nyc-csg-web.csc.nycnet";
...
window.webtrendsAsyncInit=function(){
	...
	// set NYC.gov DCSID if none is set
	if (prod_dcsId_val == "" || typeof(prod_dcsId_val) == 'undefined') {
		prod_dcsId_val = "dcskn76ek00000w84iufi6inj_8l5g";
	}
    ...
    var dcs=new Webtrends.dcs().init({
        ...
        offsite:true,
        download:true,
        downloadtypes:"sas7bdat,sas,xls,doc,pdf,txt,csv,zip,docx,xlsx,rar,gzip,3gp,arc,arj,asf,asx,edp,eps,flv,gz,ics,m3u,m4r,m4v,mov,mp3,mp4,mpeg,mpg,potx,ppam,ppsm,ppsx,ppt,pptm,pptx,psd,ram,rss,sit,svg,tar,tif,vcf,vcs,wav,wma,wmv,xlsm,xml,z",
        anchor:true,
        javascript: true,
